...
var WebARRocksFaceDebugHelper = (function(){
  const _settings = {
  ...
  function process_faceSlot(detectState, slotIndex){
   if (detectState.isDetected) {
      ...
      detectState.landmarks = landmarks; //rnd
  ...
  const that = {
    ...
    resize: function(w, h){
      ...
      if(_cv.width != w || _cv.height != h) //rnd
      {
    ...
    get_videoTransform: function(){
      return _videoTransformMat2;
    },
